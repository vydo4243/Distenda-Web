  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="flex flex-col bg-neutral-900 max-w-[607px] w-full max-h-[347px] ">
        ...
        <div className="flex flex-col self-center mt-[36px] pl-[43px] pr-[42px] w-full text-[1.5rem] font-medium leading-tight text-center text-white">
          <img
            loading="lazy"
